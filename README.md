...
- **Задержка воспроизведения** - настраиваемая задержка для синхронизации с анимацией способностей
...
- **Drag & Drop** - простое добавление звуковых файлов
...
2. **Настройте Discord**
   ...
   - Выберите "Cable Input (VB-Audio Virtual Cable)" как устройство ввода
...
- **Bass.Net** - дополнительная обработка аудио
...
- [ ] Поддержка других игр (Valorant, TFT)
...
### Q: Звуки воспроизводятся с задержкой
A: Настройте задержку в настройках конкретной способности или уменьшите задержку аудиобуфера.
...
**Сделано с ?? для сообщества League of Legends**

[? Наверх](#-lol-abilities-sound)
